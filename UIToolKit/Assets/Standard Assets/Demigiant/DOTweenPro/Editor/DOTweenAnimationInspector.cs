...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        static readonly Dictionary<DOTweenAnimationType, Type[]> _AnimationTypeToComponent = new Dictionary<DOTweenAnimationType, Type[]>() {
            ...
            { DOTweenAnimationType.Color, new[] { typeof(UISprite), typeof(UITexture), typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(Light) } },
            { DOTweenAnimationType.Fade, new[] { typeof(UISprite), typeof(UITexture), typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(CanvasGroup), typeof(Light) } },
            { DOTweenAnimationType.Text, new[] { typeof(UILabel), typeof(Text) } },
