...
{
    [CustomEditor(typeof(GalaxyDOTweenAnimation))]
    public class GalaxyDOTweenAnimationInspector : ABSAnimationInspector
    {
        enum FadeTargetType
        {
            CanvasGroup,
        ...
        static readonly Dictionary<GA.DOTweenAnimationType, Type[]> _AnimationTypeToComponent = new Dictionary<GA.DOTweenAnimationType, Type[]>() {
            { GA.DOTweenAnimationType.Move, new[] { typeof(Rigidbody), typeof(Rigidbody2D), typeof(RectTransform), typeof(Transform) } },
            { GA.DOTweenAnimationType.LocalMove, new[] { typeof(Transform) } },
            { GA.DOTweenAnimationType.Rotate, new[] { typeof(Rigidbody), typeof(Rigidbody2D), typeof(Transform) } },
            { GA.DOTweenAnimationType.LocalRotate, new[] { typeof(Transform) } },
            { GA.DOTweenAnimationType.Scale, new[] { typeof(Transform) } },
            { GA.DOTweenAnimationType.Color, new[] { typeof(UISprite), typeof(UITexture), typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(Light) } },
            { GA.DOTweenAnimationType.Fade, new[] { typeof(UISprite), typeof(UITexture), typeof(SpriteRenderer), typeof(Renderer), typeof(Image), typeof(Text), typeof(CanvasGroup), typeof(Light) } },
            { GA.DOTweenAnimationType.Text, new[] { typeof(UILabel), typeof(Text) } },
            { GA.DOTweenAnimationType.PunchPosition, new[] { typeof(RectTransform), typeof(Transform) } },
            { GA.DOTweenAnimationType.PunchRotation, new[] { typeof(Transform) } },
            { GA.DOTweenAnimationType.PunchScale, new[] { typeof(Transform) } },
            { GA.DOTweenAnimationType.ShakePosition, new[] { typeof(RectTransform), typeof(Transform) } },
            { GA.DOTweenAnimationType.ShakeRotation, new[] { typeof(Transform) } },
            { GA.DOTweenAnimationType.ShakeScale, new[] { typeof(Transform) } },
            { GA.DOTweenAnimationType.CameraAspect, new[] { typeof(Camera) } },
            { GA.DOTweenAnimationType.CameraBackgroundColor, new[] { typeof(Camera) } },
            { GA.DOTweenAnimationType.CameraFieldOfView, new[] { typeof(Camera) } },
            { GA.DOTweenAnimationType.CameraOrthoSize, new[] { typeof(Camera) } },
...
#if DOTWEEN_TK2D
        static readonly Dictionary<GA.DOTweenAnimationType, Type[]> _Tk2dAnimationTypeToComponent = new Dictionary<GA.DOTweenAnimationType, Type[]>() {
            { GA.DOTweenAnimationType.Scale, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { GA.DOTweenAnimationType.Color, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { GA.DOTweenAnimationType.Fade, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { GA.DOTweenAnimationType.Text, new[] { typeof(tk2dTextMesh) } }
        };
#endif
#if DOTWEEN_TMP
        static readonly Dictionary<GA.DOTweenAnimationType, Type[]> _TMPAnimationTypeToComponent = new Dictionary<GA.DOTweenAnimationType, Type[]>() {
            { GA.DOTweenAnimationType.Color, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { GA.DOTweenAnimationType.Fade, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { GA.DOTweenAnimationType.Text, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } }
        };
#endif
        ...
        override public void OnInspectorGUI()
        {
            ...
            if (prevAnimType != _src.animationType || ComponentsChanged())
            {
                    ...
                    && _src.GetComponent<UISprite>() != null && _src.GetComponent<UITexture>() != null && _src.GetComponent<UIWidget>() != null)
                {
                    ...
                    if (_src.forcedTargetType == TargetTypeEx.Unset) _src.forcedTargetType = _src.targetType;
            ...
            switch (_src.animationType)
            {
                ...
                case GA.DOTweenAnimationType.PunchScale:
                    ...
                    if (_src.animationType == GA.DOTweenAnimationType.PunchPosition) _src.optionalBool0 = EditorGUILayout.Toggle("    Snapping", _src.optionalBool0);
                    break;
                case GA.DOTweenAnimationType.ShakePosition:
                case GA.DOTweenAnimationType.ShakeRotation:
                case GA.DOTweenAnimationType.ShakeScale:
                    ...
                    if (_src.animationType == GA.DOTweenAnimationType.ShakePosition) _src.optionalBool0 = EditorGUILayout.Toggle("    Snapping", _src.optionalBool0);
                    break;
                case GA.DOTweenAnimationType.CameraAspect:
                case GA.DOTweenAnimationType.CameraFieldOfView:
                case GA.DOTweenAnimationType.CameraOrthoSize:
        ...
        bool Validate()
        {
            if (_src.animationType == GA.DOTweenAnimationType.None) return false;
        ...
        GA.DOTweenAnimationType AnimationToDOTweenAnimationType(string animation)
        {
            if (_datString == null) _datString = Enum.GetNames(typeof(GA.DOTweenAnimationType));
            animation = animation.Replace("/", "");
            return (GA.DOTweenAnimationType)(Array.IndexOf(_datString, animation));
        }
        int DOTweenAnimationTypeToPopupId(GA.DOTweenAnimationType animation)
        {
